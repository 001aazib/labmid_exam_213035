    ...
    public partial class Form1 : Form
    {
        public Form1()
        {
         ...
         private void Form1_Load(object sender, EventArgs e)
         {
             ...
             AddMenuItem(STARTER, "Starter 1", starterPrice);
             AddMenuItem(STARTER, "Starter 2", starterPrice);
             ...
             //  F menuFont = new Font("Arial", 12, FontStyle.Regular);
             // label1.Font = new Font("Arial", 16, FontStyle.Bold);
             // groupBox1.Font = menuFont;
             //groupBox1.Font = menuFont;
             //groupBox3.Font = menuFont;

             // Set total bill text box as read-only
             lb2.ReadOnly = true;
         }
